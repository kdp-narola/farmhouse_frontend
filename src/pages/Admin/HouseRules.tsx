    ...
    <div className="">
      <div className="mx-auto p-8">
        {/* <div className='flex justify-between mb-4'>
          <div>
            <h2 className="text-2xl font-bold text-gray-800">House Rules Management</h2>
            <p className="text-gray-600 text-sm">Manage farmhouse Rules and regulations</p>
          </div>
        ...
        {/* <div className="bg-gradient-to-r from-teal-500 to-violet-500 rounded-2xl shadow-lg p-6 mb-8 text-white">
            ...
            <div>
                ...
                <div className="text-5xl font-bold mb-1">{houserule.length}</div>
                <div className="text-lg opacity-90">Total House Rules</div>
            </div>
